...
Get this `runpod/drakes/` folder onto the pod, then run the script. From a pod
terminal (web console or SSH):
...
```bash
conda activate sedd
python /workspace/claude1/runpod/drakes/smoke_test.py --base-path /workspace/drakes_data
```
